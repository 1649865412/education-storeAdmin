...
//			cart.getShoppingCartPromotions().clear();
			...
			cart = promoService.appendPromoInfo(cart, RequestContext
					.getCurrentUser());
			// save
...
//		cart.getShoppingCartPromotions().clear();
		// This is a bug which is always locking the shoppingcart_promotion table.
